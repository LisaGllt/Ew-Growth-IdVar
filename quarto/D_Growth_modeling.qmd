...
Recuperation of likelihood data :

```{r}
df_likelihood <- posterior_samples(m.sim.post)  

likelihood_L0_mu <- df_likelihood %>%
  select(b_L0_Intercept)

likelihood_L0_sd <- df_likelihood %>%
  select(sd_ID__L0_Intercept)

likelihood_a_ctrl_mu <- df_likelihood %>%
  select(b_a_exposition0)

likelihood_a_trt_mu <- df_likelihood %>%
  select(b_a_exposition1)

likelihood_a_ctrl_sd <- df_likelihood %>%
  select(sd_ID__a_exposition0)

likelihood_a_trt_sd <- df_likelihood %>%
  select(sd_ID__a_exposition1)

likelihood_sigma <- df_likelihood %>%
  select(sigma)
...
plot_L0_mu <-
  ...
  stat_halfeye(
    data = likelihood_L0_mu,
    aes(x = b_L0_Intercept),
    fill = col_like, 
    color = col_like,
    alpha = alpha_like
  )+
...
plot_L0_sd <-
  ...
  stat_halfeye(
    data = likelihood_L0_sd,
    aes(x = sd_ID__L0_Intercept),
    fill = col_like,  
    color = col_like,
    alpha = alpha_like
  )+
...
plot_a_ctrl_mu <-
  ...
  stat_halfeye(
    data = likelihood_a_ctrl_mu,
    aes(x = b_a_exposition0),
    fill = col_like,  
    color = col_like,
    alpha = alpha_like
  )+
...
plot_a_trt_mu <-
  ...
  stat_halfeye(
    data = likelihood_a_trt_mu,
    aes(x = b_a_exposition1),
    fill = col_like,  
    color = col_like,
    alpha = alpha_like
  )+
...
plot_a_ctrl_sd <-
  ...
  stat_halfeye(
    data = likelihood_a_ctrl_sd,
    aes(x = sd_ID__a_exposition0),
    fill = col_like,  
    color = col_like,
    alpha = alpha_like
  )+
...
plot_a_trt_sd <-
  ...
  stat_halfeye(
    data = likelihood_a_trt_sd,
    aes(x = sd_ID__a_exposition1),
    fill = col_like,  
    color = col_like,
    alpha = alpha_like
  )+
