...
# a_trt_mean <- mean(subset(df_estimates, exposition == 1)$a_i)
# length(subset(df_estimates, a_i < a_trt_mean*0.9)$ID)/length(subset(df_estimates, exposition == 1)$ID)
...
ggsave(
  filename="ModVI_predobs_weights.jpg", 
  plot=plot_predobs_log, 
  width=12, height = 13, 
  path=here::here("fig/")
  )
